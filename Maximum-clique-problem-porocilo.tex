...
\centering
\includegraphics[width=10cm, height=5cm]{klika1}
\end{figure}

\begin{figure}[h]
\caption{Maksimalna klika na podgrafu velikosti 30}
\centering
\includegraphics[width=10cm, height=6cm]{klika2}
\end{figure}


%Reševanja problema iskanja maksimalne klike se bova lotili v programskem jeziku Sage in sicer na konkretnem grafu. 


%\section{Glavne ideje programa ali psevdokoda}
%\section{Opis generiranja ali izbiranja podatkov / opis uporabljenih funkcij}
